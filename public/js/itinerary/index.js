document.addEventListener('DOMContentLoaded', function(){
    ...
    let dBSelectedDestination = document.getElementById("_selected_destination")?.dataset?.selected_destination;
    ...
    if(dBSelectedDestination){
        optionsArray.forEach(option => {
            const optionElement = document.createElement("option");
            optionElement.value = option.value;
            if(dBSelectedDestination==option.value){
